...
exports.seed = function(knex, Promise) {
  return knex('steps').del()
    .then(function () {
      return Promise.all([
        knex('steps').insert({id: 0, recipe_id: 0, instructions: 'step_one', audio_path: 'https://www.youtube.com/watch?v=2lmBUq1Zd34' }),
        knex('steps').insert({id: 1, recipe_id: 0, instructions: 'step_two', audio_path: 'https://www.youtube.com/watch?v=l7H4aNciRh8'}),
        knex('steps').insert({id: 2, recipe_id: 0, instructions: 'step_three', audio_path: 'https://www.youtube.com/watch?v=SGTPnvW4jpw'}),
