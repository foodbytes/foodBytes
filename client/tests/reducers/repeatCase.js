...
import reducer from '../../reducers'
import { REPEAT } from '../../actions/actionCreators'
...
test('reducer with basic REPEAT action with active_audio_path as an array', t=> {
  ...
  t.deepEqual(actualState, expectedState, 'the reducer repeats the active_audio_path if it is an array')
  t.end()
})
...
test('reducer with basic REPEAT action with active_audio_path as a string', t=> {
  ...
  var fakeState = {
    recipe:{
      ...
      active_audio_path: '../audio/ingredients.mp3',
      playing: true,
      listening: false
    },
    routing: { locationBeforeTransitions: null }
  ...
  t.deepEqual(actualState, expectedState, 'the reducer repeats the active_audio_path if it is a string')
  t.end()
})
