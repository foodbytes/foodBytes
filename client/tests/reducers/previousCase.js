...
import { PREVIOUS } from '../../actions/actionCreators'
...
test('reducer with basic PREVIOUS action does nothing when at the first item in the array', t=> {
...
test('reducer with basic PREVIOUS action returns an array as active_audio_path if active_audio_path is a string in initialState', t=> {
